...
const HighlightMode = () => (
  <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" width="16" height="16">
    <path d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
  </svg>
)
...
const ZoomOut = () => (
  <svg fill="none" width="18" height="18" viewBox="0 0 24 24" stroke="currentColor">
...
const ToolbarItem = (props: ToolbarItemProps) => {
  return (
    <a className={clsx("mhtml-plugin__toolbar-item", props.isActive ? 'is-active' : '')}>{props.children}</a>
  )
}
